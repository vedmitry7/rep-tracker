...
BOT_NAME = "Repka · Трекер упражнений"
BOT_COMMANDS = {
    "menu": "Меню",
    "settings": "Настройки",
    "help": "Помощь",
}
BOT_SHORT_DESCRIPTION = "Трекер упражнений, прогресса и недельных отчётов."
BOT_DESCRIPTION = (
    "🥬 Repka — трекер упражнений в Telegram.\n\n"
    "Записывай подходы и повторения одной строкой: 16, 4×10 или 12, 10, 8. "
    "Repka сохранит результат, посчитает повторения за день, неделю и месяц "
    "и покажет прогресс по каждому упражнению.\n\n"
    "📊 Статистика и история тренировок\n"
    "🖼 Недельные отчёты, которыми можно поделиться\n"
...
WELCOME = (
    "🥬 Привет! Я Repka.\n\n"
    "Я запоминаю твои тренировки и превращаю обычные числа в понятную историю "
    "прогресса.\n\n"
    "Начать очень просто:\n"
    "1. Добавь упражнение — например, «Подтягивания».\n"
    "2. После тренировки отправь результат: 16, 4×10 или 12, 10, 8.\n"
    "3. Я всё сохраню и посчитаю статистику.\n\n"
    "Со временем здесь появятся история тренировок, прогресс за неделю и месяц "
    "и недельные отчёты, которыми можно поделиться.\n\n"
    "Твои данные можно импортировать и экспортировать — они не заперты внутри Repka.\n\n"
    "👇 Создай первое упражнение — это займёт несколько секунд."
)
HELP = (
    "ℹ️ Помощь\n\n"
...
BUTTON_ADD_FIRST_EXERCISE = "➕ Добавить первое упражнение"
