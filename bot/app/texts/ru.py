...
BOT_DESCRIPTION = (
    "🥬 Репка — простой трекер упражнений в Telegram.\n\n"
    "Записывай подтягивания, отжимания, приседания и любые другие упражнения прямо "
    "в чате. Отправь результат: 16, 4×10 или 12, 10, 8 — Репка сохранит тренировку, "
    "посчитает объём и покажет твой прогресс.\n\n"
    "📊 Статистика за неделю и месяц\n"
    "📈 История и динамика результатов\n"
    "🖼 Красивые недельные отчёты\n"
...
WELCOME = (
    ...
    "Твои данные можно импортировать и экспортировать — они не заперты внутри Репки.\n\n"
